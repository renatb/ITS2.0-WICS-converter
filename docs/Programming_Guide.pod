=head1 Programming Guide for the WICS Converters
...
To run C<scripts/GenerateDocs.pl> (see L</Viewing and Generating Documentation>), you must have L<Pod::Simple::HTMLBatch|https://metacpan.org/module/PAR::Packer> installed.
...
All at once: C<prove -lrv> or if you're less patient, C<prove -lr -j4>. The options do the following:
...
=head2 Community Contributions During Project Development

=head3 Bug Reports

=over

=item L<allow specification of directory in DZP::Sharedir|https://rt.cpan.org/Ticket/Display.html?id=83773>

=item L<change running order of DZP::Sharedir|https://rt.cpan.org/Ticket/Display.html?id=83773>

=item L<XPath requires lower-casing to query attributes in Chromium|https://code.google.com/p/chromium/issues/detail?id=179453&thanks=179453&ts=1362167145>

=item L<Process variables in XML::Twig|https://github.com/mirod/xmltwig/issues/8>

=item L<printing wrong doctype in XML::LibXML|https://rt.cpan.org/Ticket/Display.html?id=87089>

=item L<unique_key method in XML::LibXML::node|https://rt.cpan.org/Ticket/Display.html?87425> (L<pull request|https://bitbucket.org/shlomif/perl-xml-libxml/pull-request/20/unique_key-method-for-nodes/diff>)

=item L<-M crashes pp if option contains backslashes|https://rt.cpan.org/Ticket/Display.html?88297>

=item L<IPC-Cmd blocks if command reads E<lt>STDINE<gt> (on Win32)|https://rt.cpan.org/Ticket/Display.html?88315>

=item L<MBP:CPANfile Crashes perl on Windows during install|https://rt.cpan.org/Ticket/Display.html?88304>

=item L<Capture::Tiny Crashes with fork on Windows|https://github.com/dagolden/capture-tiny/issues/12>

=item L<Module::Build::Pluggable uses fork|https://github.com/tokuhirom/Module-Build-Pluggable/issues/2>

=item L<Use IO::Prompt::Tiny in Metabase::Fact|https://github.com/dagolden/metabase-fact/pull/2>

=item L<Win32::Unicode test failure|https://github.com/xaicron/p5-win32-unicode/issues/3>

=item L<Null namespace crashes HTML::HTML5::Writer|https://rt.cpan.org/Ticket/Display.html?id=88621>

=item L<Space required to Parse File with HTML::HTML5::Parser|https://rt.cpan.org/Ticket/Display.html?id=88636>

=item L<Compare all types of nodes with Test::XML::Ordered|https://rt.cpan.org/Ticket/Display.html?id=88994>

=item L<xml:id and provenanceRecordsRef switched in ITS test suite|https://github.com/finnle/ITS-2.0-Testsuite/pull/22>

=item L<Illegal itemprops in ITS test suite|https://github.com/finnle/ITS-2.0-Testsuite/pull/23>

=item L<Incorrect ITS in XLIFF files in ITS test suite|https://github.com/w3c/its-2.0-testsuite/issues/2#issuecomment-25061424>

=item L<Log::Any- don't C<require> loaded packages|https://github.com/dagolden/Log-Any/pull/2>

=back

=head3 ITS Interest Group Discussions

=over

=item L<XPath Context for Relative Selectors|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Jul/0035.html>

=item L<XPath Context for idValue Evaluation|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Jul/0037.html>

=item L<Separating Precedence of 2 Types of Inheritance|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Aug/0007.html>

=item L<ITS Reset for Inherited Metadata|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Aug/0001.html>

=item L<ITS-Version in HTML|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Aug/0021.html>

=item L<Namespace-less Atts in ITS standard|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Aug/0027.html>

=item L<Differentiate Source and Target Notes in XLIFF Mapping|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Sep/0006.html>

=item L<Typos in XLIFF Mapping|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Sep/0005.html>

=item L<"nel" Value for its:lineBreakType|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Sep/0017.html>

=item L<ITS Rules in XLIFF|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Sep/0029.html>

=item L<Is C<mtype="x-its"> required?|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Oct/0005.html>

=item L<Exclusivity and atomicity of local and global ITS|http://lists.w3.org/Archives/Public/public-i18n-its-ig/2013Oct/0006.html>
