...
To run C<scripts/GenerateDocs.pl> (see L</Viewing and Generating Documentation>), you must have L<Pod::Simple::HTMLBatch|https://metacpan.org/module/PAR::Packer> installed, along with several of the dependencies required to run C<dzil>.
